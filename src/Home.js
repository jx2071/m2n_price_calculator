      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            为您量身定制家居装修方案。我们详细列出每一项费用，并提供个性化选择。让您清晰了解每个环节的花费。我们的团队将为您提供全方位的支持和建议，确保您的装修计划在预算范围内顺利进行。
          </p>
                            ...
                            <div>
                              <div className="mt-2 flex item-center justify-center">
                                <input
                                  ...
                                  autoComplete="off"
                                  required
                                  className="block w-10 rounded-md border-0 py-1.5 pl-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                />
